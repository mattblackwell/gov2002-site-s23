...
The equivalent of [Gov 51](http://gov51.mattblackwell.org) is required and Gov 2001 is highly recommended. We will also assume some familiarity with calculus and linear algebra at the level of the [Gov Math Prefresher](https://projects.iq.harvard.edu/prefresher/home). Because we'll be using more linear algebra than in 2001, we have also set up a mostly self-guided [Gov January Linear Algebra Review](https://github.com/mattblackwell/gov-january-math-refresher/blob/main/plan.md) for students to complete ahead of the course to get up to speed with those concepts. We assume basic familiarity with R, Rmarkdown, and LaTeX. 
...
| Problem Set 5  | Thu, Mar 9th 12:00pm ET  | Wed, Mar 20th  11:59pm ET |
| Problem Set 6  | Thu, Mar 22nd 12:00pm ET | Wed, Mar 29th  11:59pm ET |
...
Unfortunately, there are no perfect references that cover everything we do in Gov 2002. I will mostly try to follow material from a couple of different books. The first of which is currently freely available on the internet. The other two Hansen books are good references but may be more dense that the Blitzstein and Hwang book. 
